...
pub type SOURCESEL_W<'a> = crate::FieldWriter<'a, u32, CH10_CTRL_SPEC, u8, SOURCESEL_A, 6, 16>;
...
pub type EDSEL_W<'a> = crate::FieldWriterSafe<'a, u32, CH10_CTRL_SPEC, u8, EDSEL_A, 2, 24>;
impl<'a> EDSEL_W<'a> {
...
pub type ASYNC_W<'a> = crate::BitWriter<'a, u32, CH10_CTRL_SPEC, bool, 28>;
impl R {
