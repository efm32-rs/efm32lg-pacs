...
pub struct R(crate::R<HC7_INT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HC7_INT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HC7_INT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HC7_INT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HC7_INT` writer"]
pub struct W(crate::W<HC7_INT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HC7_INT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HC7_INT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HC7_INT_SPEC>) -> Self {
        W(writer)
    }
}
