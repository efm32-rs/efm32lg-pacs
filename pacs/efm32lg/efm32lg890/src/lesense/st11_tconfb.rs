...
pub type NEXTSTATE_W<'a> = crate::FieldWriter<'a, u32, ST11_TCONFB_SPEC, u8, u8, 4, 8>;
...
pub type PRSACT_W<'a> = crate::FieldWriter<'a, u32, ST11_TCONFB_SPEC, u8, u8, 3, 12>;
#[doc = "Field `SETIF` reader - Set interrupt flag"]
pub type SETIF_R = crate::BitReader<bool>;
#[doc = "Field `SETIF` writer - Set interrupt flag"]
pub type SETIF_W<'a> = crate::BitWriter<'a, u32, ST11_TCONFB_SPEC, bool, 16>;
impl R {
