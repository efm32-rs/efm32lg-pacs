...
pub struct R(crate::R<DOEP3_TSIZ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DOEP3_TSIZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DOEP3_TSIZ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DOEP3_TSIZ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DOEP3_TSIZ` writer"]
pub struct W(crate::W<DOEP3_TSIZ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DOEP3_TSIZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DOEP3_TSIZ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DOEP3_TSIZ_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XFERSIZE_W<'a> = crate::FieldWriter<'a, u32, DOEP3_TSIZ_SPEC, u32, u32, 19, 0>;
#[doc = "Field `PKTCNT` reader - Packet Count"]
pub type PKTCNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PKTCNT` writer - Packet Count"]
pub type PKTCNT_W<'a> = crate::FieldWriter<'a, u32, DOEP3_TSIZ_SPEC, u16, u16, 10, 19>;
