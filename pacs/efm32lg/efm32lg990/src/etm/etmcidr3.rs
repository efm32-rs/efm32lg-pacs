...
pub struct R(crate::R<ETMCIDR3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETMCIDR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETMCIDR3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETMCIDR3_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Component ID3 Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [etmcidr3](index.html) module"]
