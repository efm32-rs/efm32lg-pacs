...
pub type BODCAL_W<'a, const O: u8> = crate::BitWriter<'a, u32, BUCTRL_SPEC, bool, O>;
...
pub type BUMODEBODEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, BUCTRL_SPEC, bool, O>;
...
pub type PROBE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, BUCTRL_SPEC, u8, PROBE_A, 2, O>;
impl<'a, const O: u8> PROBE_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bodcal(&mut self) -> BODCAL_W<2> {
        BODCAL_W::new(self)
    }
    #[doc = "Bit 3 - Enable brown out detection on BU_VIN when in backup mode"]
    #[inline(always)]
    #[must_use]
    pub fn bumodeboden(&mut self) -> BUMODEBODEN_W<3> {
        BUMODEBODEN_W::new(self)
    }
    #[doc = "Bits 5:6 - Voltage probe select"]
    #[inline(always)]
    #[must_use]
    pub fn probe(&mut self) -> PROBE_W<5> {
        PROBE_W::new(self)
    }
