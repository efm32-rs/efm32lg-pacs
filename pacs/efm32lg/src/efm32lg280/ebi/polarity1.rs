...
pub type CSPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, POLARITY1_SPEC, bool, O>;
...
pub type REPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, POLARITY1_SPEC, bool, O>;
...
pub type WEPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, POLARITY1_SPEC, bool, O>;
...
pub type ALEPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, POLARITY1_SPEC, bool, O>;
#[doc = "Field `ARDYPOL` reader - ARDY Polarity"]
pub type ARDYPOL_R = crate::BitReader<bool>;
#[doc = "Field `ARDYPOL` writer - ARDY Polarity"]
pub type ARDYPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, POLARITY1_SPEC, bool, O>;
#[doc = "Field `BLPOL` reader - BL Polarity"]
pub type BLPOL_R = crate::BitReader<bool>;
#[doc = "Field `BLPOL` writer - BL Polarity"]
pub type BLPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, POLARITY1_SPEC, bool, O>;
impl R {
