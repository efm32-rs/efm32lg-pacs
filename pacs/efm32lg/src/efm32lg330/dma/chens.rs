...
pub type CH8ENS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHENS_SPEC, bool, O>;
#[doc = "Field `CH9ENS` writer - Channel 9 Enable Set"]
pub type CH9ENS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHENS_SPEC, bool, O>;
#[doc = "Field `CH10ENS` writer - Channel 10 Enable Set"]
pub type CH10ENS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHENS_SPEC, bool, O>;
#[doc = "Field `CH11ENS` writer - Channel 11 Enable Set"]
pub type CH11ENS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHENS_SPEC, bool, O>;
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch8ens(&mut self) -> CH8ENS_W<8> {
        CH8ENS_W::new(self)
    }
    #[doc = "Bit 9 - Channel 9 Enable Set"]
    #[inline(always)]
    #[must_use]
    pub fn ch9ens(&mut self) -> CH9ENS_W<9> {
        CH9ENS_W::new(self)
    }
    #[doc = "Bit 10 - Channel 10 Enable Set"]
    #[inline(always)]
    #[must_use]
    pub fn ch10ens(&mut self) -> CH10ENS_W<10> {
        CH10ENS_W::new(self)
    }
    #[doc = "Bit 11 - Channel 11 Enable Set"]
    #[inline(always)]
    #[must_use]
    pub fn ch11ens(&mut self) -> CH11ENS_W<11> {
        CH11ENS_W::new(self)
    }
