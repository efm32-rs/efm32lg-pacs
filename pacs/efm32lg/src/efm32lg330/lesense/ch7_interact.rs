...
pub type ACMPTHRES_W<'a> = crate::FieldWriter<'a, u32, CH7_INTERACT_SPEC, u16, u16, 12, 0>;
...
pub type SAMPLE_W<'a> = crate::BitWriter<'a, u32, CH7_INTERACT_SPEC, bool, 12>;
...
pub type SETIF_W<'a> = crate::FieldWriterSafe<'a, u32, CH7_INTERACT_SPEC, u8, SETIF_A, 2, 13>;
impl<'a> SETIF_W<'a> {
...
pub type EXMODE_W<'a> = crate::FieldWriterSafe<'a, u32, CH7_INTERACT_SPEC, u8, EXMODE_A, 2, 15>;
impl<'a> EXMODE_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
...
pub type EXCLK_W<'a> = crate::BitWriter<'a, u32, CH7_INTERACT_SPEC, bool, 17>;
...
pub type SAMPLECLK_W<'a> = crate::BitWriter<'a, u32, CH7_INTERACT_SPEC, bool, 18>;
...
pub type ALTEX_W<'a> = crate::BitWriter<'a, u32, CH7_INTERACT_SPEC, bool, 19>;
impl R {
