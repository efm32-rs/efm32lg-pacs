...
#[doc = "Field `COMP0` reader - Compare match value"]
pub type COMP0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `COMP0` writer - Compare match value"]
pub type COMP0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMP0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Compare match value"]
    #[inline(always)]
    pub fn comp0(&self) -> COMP0_R {
        COMP0_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Compare match value"]
