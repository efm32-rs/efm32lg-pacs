...
pub type SAMPLEDLY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH4_TIMING_SPEC, u8, u8, 7, O>;
...
pub type MEASUREDLY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH4_TIMING_SPEC, u8, u8, 7, O>;
impl R {
