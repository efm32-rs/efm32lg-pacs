...
#[doc = "DIEP3_TXFSTS (r) register accessor: an alias for `Reg<DIEP3_TXFSTS_SPEC>`"]
...
#[doc = "DIEP4_TXFSTS (r) register accessor: an alias for `Reg<DIEP4_TXFSTS_SPEC>`"]
...
#[doc = "DIEP5_TXFSTS (r) register accessor: an alias for `Reg<DIEP5_TXFSTS_SPEC>`"]
