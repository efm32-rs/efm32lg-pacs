...
pub type NAK_W<'a> = crate::BitWriter<'a, u32, HC8_INT_SPEC, bool, 4>;
...
pub type ACK_W<'a> = crate::BitWriter<'a, u32, HC8_INT_SPEC, bool, 5>;
...
pub type DATATGLERR_W<'a> = crate::BitWriter<'a, u32, HC8_INT_SPEC, bool, 10>;
impl R {
