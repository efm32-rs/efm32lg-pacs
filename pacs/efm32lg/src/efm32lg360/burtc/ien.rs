...
#[doc = "Field `COMP0` reader - Compare match Interrupt Enable"]
pub type COMP0_R = crate::BitReader<bool>;
#[doc = "Field `COMP0` writer - Compare match Interrupt Enable"]
pub type COMP0_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
#[doc = "Field `LFXOFAIL` reader - LFXO failure Interrupt Enable"]
pub type LFXOFAIL_R = crate::BitReader<bool>;
#[doc = "Field `LFXOFAIL` writer - LFXO failure Interrupt Enable"]
pub type LFXOFAIL_W<'a, const O: u8> = crate::BitWriter<'a, u32, IEN_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lfxofail(&mut self) -> LFXOFAIL_W<2> {
        LFXOFAIL_W::new(self)
    }
