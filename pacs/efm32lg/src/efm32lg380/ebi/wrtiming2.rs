...
pub type WRSETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRTIMING2_SPEC, u8, u8, 2, O>;
...
pub type WRSTRB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRTIMING2_SPEC, u8, u8, 6, O>;
#[doc = "Field `WRHOLD` reader - Write Hold Time"]
pub type WRHOLD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `WRHOLD` writer - Write Hold Time"]
pub type WRHOLD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRTIMING2_SPEC, u8, u8, 2, O>;
...
pub type HALFWE_W<'a, const O: u8> = crate::BitWriter<'a, u32, WRTIMING2_SPEC, bool, O>;
...
pub type WBUFDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, WRTIMING2_SPEC, bool, O>;
impl R {
