...
pub mod ctrl;
#[doc = "RDS (rw) register accessor: an alias for `Reg<RDS_SPEC>`"]
pub type RDS = crate::Reg<rds::RDS_SPEC>;
#[doc = "DMA Retain Descriptor State"]
pub mod rds;
#[doc = "LOOP0 (rw) register accessor: an alias for `Reg<LOOP0_SPEC>`"]
pub type LOOP0 = crate::Reg<loop0::LOOP0_SPEC>;
#[doc = "Channel 0 Loop Register"]
pub mod loop0;
#[doc = "LOOP1 (rw) register accessor: an alias for `Reg<LOOP1_SPEC>`"]
pub type LOOP1 = crate::Reg<loop1::LOOP1_SPEC>;
#[doc = "Channel 1 Loop Register"]
pub mod loop1;
#[doc = "RECT0 (rw) register accessor: an alias for `Reg<RECT0_SPEC>`"]
