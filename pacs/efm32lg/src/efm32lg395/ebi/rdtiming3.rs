...
pub type RDSETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RDTIMING3_SPEC, u8, u8, 2, O>;
...
pub type RDSTRB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RDTIMING3_SPEC, u8, u8, 6, O>;
#[doc = "Field `RDHOLD` reader - Read Hold Time"]
pub type RDHOLD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RDHOLD` writer - Read Hold Time"]
pub type RDHOLD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RDTIMING3_SPEC, u8, u8, 2, O>;
...
pub type HALFRE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RDTIMING3_SPEC, bool, O>;
...
pub type PREFETCH_W<'a, const O: u8> = crate::BitWriter<'a, u32, RDTIMING3_SPEC, bool, O>;
...
pub type PAGEMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RDTIMING3_SPEC, bool, O>;
impl R {
...
#[doc = "`reset()` method sets RDTIMING3 to value 0x0003_3f03"]
