...
pub type ACMPTHRES_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH1_INTERACT_SPEC, u16, u16, 12, O>;
...
pub type SAMPLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH1_INTERACT_SPEC, bool, O>;
...
pub type SETIF_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CH1_INTERACT_SPEC, u8, SETIF_A, 2, O>;
