...
pub struct R(crate::R<SEGD3H_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SEGD3H_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SEGD3H_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SEGD3H_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SEGD3H` writer"]
pub struct W(crate::W<SEGD3H_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SEGD3H_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SEGD3H_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SEGD3H_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SEGD3H` reader - COM3 Segment Data High"]
pub type SEGD3H_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SEGD3H` writer - COM3 Segment Data High"]
pub type SEGD3H_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SEGD3H_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn segd3h(&mut self) -> SEGD3H_W<0> {
        SEGD3H_W::new(self)
    }
