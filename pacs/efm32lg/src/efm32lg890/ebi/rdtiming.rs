...
pub type RDSTRB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RDTIMING_SPEC, u8, u8, 6, O>;
...
pub type HALFRE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RDTIMING_SPEC, bool, O>;
...
pub type PREFETCH_W<'a, const O: u8> = crate::BitWriter<'a, u32, RDTIMING_SPEC, bool, O>;
...
pub type PAGEMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RDTIMING_SPEC, bool, O>;
impl R {
...
#[doc = "`reset()` method sets RDTIMING to value 0x0003_3f03"]
